<template>
  <div>
    <div class="seleTile">
      ...
      <Page show-elevator show-sizer show-total :total="dataCount" placement="top" :page-size="pageParam.pageSize" :current.sync="pageParam.pageIndex" :page-size-opts="[10, 20, 40, 60, 100]" @on-change="changepage" style="text-align: right" @on-page-size-change="pageSizeChange" />
    </div>
...
<script>
import { getEosnode } from '@/api/data';
export default {
  name: 'Eosnode',
  data () {
    return {
  ...
  methods: {
    ...
    getOperation () {
      getEosnode(this.pageParam.pageSize, this.pageParam.pageIndex, this.make, this.nodeStatus).then(res => {
